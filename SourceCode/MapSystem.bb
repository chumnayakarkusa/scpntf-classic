Include "SourceCode\Rooms\Room2_Servers_2.bb"
Include "SourceCode\Rooms\Room2_Tesla.bb"
Include "SourceCode\Rooms\Room2_Toilets.bb"
Include "SourceCode\Rooms\Room2_Tunnel_2.bb"
Include "SourceCode\Rooms\Room2_Upper_Office.bb"
Include "SourceCode\Rooms\Room2C_Pit.bb"
Include "SourceCode\Rooms\Room2C_Research.bb"
Include "SourceCode\Rooms\Room3_EZ.bb"
Include "SourceCode\Rooms\Room3_GW.bb"
Include "SourceCode\Rooms\Room3_HCZ.bb"
Include "SourceCode\Rooms\Room3_Offices.bb"
Include "SourceCode\Rooms\Room3_Pit.bb"
Include "SourceCode\Rooms\Room3_Servers_1.bb"
Include "SourceCode\Rooms\Room3_Servers_2.bb"
Include "SourceCode\Rooms\Room3_Storage.bb"
Include "SourceCode\Rooms\Room3_Tunnel.bb"
Include "SourceCode\Rooms\Room3_Window.bb"
Include "SourceCode\Rooms\Surveil_Room.bb"
Include "SourceCode\Rooms\Testmap.bb"
Include "SourceCode\Rooms\Testroom_2B.bb"
Include "SourceCode\Rooms\Testroom_682.bb"
Include "SourceCode\Rooms\Testroom_860.bb"

;Map constants
;[Block]
Const MaxRoomLights% = 128 ;32
Const MaxRoomEmitters% = 16
Const MaxRoomObjects% = 30
Const ROOM1% = 1, ROOM2% = 2, ROOM2C% = 3, ROOM3% = 4, ROOM4% = 5
Const MapGridSize% = 18
Const MapGridSizeEZ% = 18;12
...
Function FillRoom(r.Rooms)
	...
	Select r\RoomTemplate\Name
		Case "area_076"
			FillRoom_Area_076(r)
		Case "checkpoint_ez"
			FillRoom_Checkpoint_EZ(r)
		Case "checkpoint_lcz","checkpoint_hcz"
		...
		Case "cont_970"
			FillRoom_Cont_970(r)
		Case "cont_1123"
			FillRoom_Cont_1123(r)
		Case "cont_1162"
			FillRoom_Cont_1162(r)
		Case "electrical_center"
			FillRoom_Electrical_Center(r)
		Case "endroom_1"
		...
		Case "room2_3","room3_3"
			w.waypoints = CreateWaypoint(r\x, r\y + 66.0 * RoomScale, r\z, Null, r) ;I guess that can still be like that - ENDSHN
		Case "room2_4"
			FillRoom_Room2_4(r)	
		Case "room2_cafeteria"
			FillRoom_Room2_Cafeteria(r)
		Case "room2_closets"
			FillRoom_Room2_Closets(r)
		Case "room2_doors"
			FillRoom_Room2_Doors(r)
		Case "room2_dr_offices_1"
			FillRoom_Room2_Dr_Offices_1(r)
		Case "room2_dr_offices_2"
			FillRoom_Room2_Dr_Offices_2(r)	
		Case "room2_elevator_1"
			FillRoom_Room2_Elevator_1(r)
		Case "room2_elevator_2"
			FillRoom_Room2_Elevator_2(r)
		Case "room2_ez_1"
		...
		Case "room2_living_facility"
			FillRoom_Room2_Living_Facility(r)
		...
		Case "room2_offices_4"
			FillRoom_Room2_Offices_4(r)
		...
		Case "room2_servers_1"
			FillRoom_Room2_Servers_1(r)
		Case "room2_servers_2"
			FillRoom_Room2_Servers_2(r)
		Case "room2_tesla_ez","room2_tesla_lcz","room2_tesla_hcz"
		...
		Case "room2_z1office"	
			FillRoom_Room2_LCZ_Offices_1(r)	
		Case "room2c_pit"
		...
		Case "room3_offices"
			FillRoom_Room3_Offices(r)
		Case "room3_pit"
			FillRoom_Room3_Pit(r)
		Case "room3_servers_1"
			FillRoom_Room3_Servers_1(r)
		Case "room3_servers_2"
			FillRoom_Room3_Servers_2(r)
		Case "room3_storage"
			FillRoom_Room3_Storage(r)
		Case "room3_tunnel"
			Fillroom_Room3_Tunnel(r)
		Case "room3_window"
			FillRoom_Room3_Window(r)
		Case "room4_tunnel"
				...
				If sc\Screen Then
					...
					If (sc\CoffinEffect = 1 Lor sc\CoffinEffect = 3) And (Not Wearing714) And WearingHazmat <> 3 And WearingGasMask <> 3 Then
						If sc\InSight Then
							...
							Pvt = FreeEntity_Strict(Pvt)
							If (sc\CoffinEffect = 1 Lor sc\CoffinEffect = 3) And ((Not Wearing714) And WearingGasMask <> 3 And WearingHazmat <> 3) Then
								If Sanity < -800.0 Then
									...
									EndIf	
									BlurTimer = 1000.0
									If VomitTimer = 0.0 Then VomitTimer = 1.0
								ElseIf Sanity < -500.0
					...
					Else
						If sc\InSight Then
							If Wearing714 Lor WearingHazmat = 3 Lor WearingGasMask = 3 Then EntityTexture(sc\ScrOverlay, MonitorTexture)
						EndIf
					EndIf
...
Function CreateMap()
	...
	If NTF_CurrZone > 0 And NTF_CurrZone < 4 Then
		;Set a starting position
		startX = Rand(0,grid_size-1)
		...
		y = 1
		x = startX
		CurrGrid\Grid[x+grid_size] = MapGrid_Tile
		...
		Repeat
			...
			Select dir
				Case 0 ;down
					If y < grid_size-(dimensions+1) Then
						y = y + dimensions
						For n = 1 To dimensions-1
							CurrGrid\Grid[x+((y-n)*grid_size)] = MapGrid_Tile
						Next
						success = True
					EndIf
				Case 1 ;left
					If x >= dimensions Then
						x = x - dimensions
						For n = 1 To dimensions-1
							CurrGrid\Grid[(x+n)+(y*grid_size)] = MapGrid_Tile
						Next
						success = True
					EndIf
				Case 2 ;up
					...
					EndIf
				Case 3 ;right
					If x <= grid_size-(dimensions+1) Then
						x = x + dimensions
						For n = 1 To dimensions-1
							CurrGrid\Grid[(x-n)+(y*grid_size)] = MapGrid_Tile
						Next
			...
			End Select
			If success Then
				CurrGrid\Grid[x+(y*grid_size)] = MapGrid_Tile
				i = i + 1
			EndIf
		Until ((i >= loopamount) And (y>=grid_size-2))
		
		DebugLog "Map Generator Stage 1 complete"
		
		;Add the end position
		endX = x
		CurrGrid\Grid[endX+((grid_size-1)*grid_size)] = MapGrid_EndTile
		...
		Repeat
			For x = 1 To grid_size-2
				For y = 1 To grid_size-2
					If CurrGrid\Grid[x+(y*grid_size)]=MapGrid_NoTile And Rand(1,15)=1 Then
						adj_amount = 0
						If CurrGrid\Grid[x+((y+1)*grid_size)]>MapGrid_NoTile Then
							adj_amount = adj_amount + 1
						EndIf
						If CurrGrid\Grid[x+((y-1)*grid_size)]>MapGrid_NoTile Then
							adj_amount = adj_amount + 1
						EndIf
						If CurrGrid\Grid[(x+1)+(y*grid_size)]>MapGrid_NoTile Then
							adj_amount = adj_amount + 1
						EndIf
						If CurrGrid\Grid[(x-1)+(y*grid_size)]>MapGrid_NoTile Then
							adj_amount = adj_amount + 1
		...
		For y = 1 To grid_size-2
			For x = 0 To grid_size-1
				If CurrGrid\Grid[x+(y*grid_size)] > 0 Then
					temp = 0
					If x < grid_size-1 Then
						temp=Min(CurrGrid\Grid[(x+1)+(y*grid_size)],1)
					EndIf
					If x > 0 Then
						temp=temp+Min(CurrGrid\Grid[(x-1)+(y*grid_size)],1)
					EndIf
					temp=temp+Min(CurrGrid\Grid[x+((y+1)*grid_size)],1)+Min(CurrGrid\Grid[x+((y-1)*grid_size)],1)
					
					DebugLog temp
					
					Select temp
						Case 1
							If CurrGrid\Grid[x+((y+1)*grid_size)]>0 Then
								CurrGrid\RoomAngle[x+(y*grid_size)] = 2
							ElseIf CurrGrid\Grid[(x-1)+(y*grid_size)]>0 And (x>=0) Then
								CurrGrid\RoomAngle[x+(y*grid_size)] = 3
							ElseIf CurrGrid\Grid[(x+1)+(y*grid_size)]>0 And (x<grid_size-1) Then
								CurrGrid\RoomAngle[x+(y*grid_size)] = 1
							Else
								CurrGrid\RoomAngle[x+(y*grid_size)] = 0
							EndIf
							CurrGrid\RoomType[x+(y*grid_size)] = ROOM1
						Case 2
							If CurrGrid\Grid[(x-1)+(y*grid_size)]>0 And CurrGrid\Grid[(x+1)+(y*grid_size)]>0 And (x>=0) And (x<grid_size-1) Then
								If Rand(2) = 1 Then
									CurrGrid\RoomAngle[x+(y*grid_size)] = 1
								Else
									CurrGrid\RoomAngle[x+(y*grid_size)] = 3
								EndIf
								CurrGrid\RoomType[x+(y*grid_size)] = ROOM2
							ElseIf CurrGrid\Grid[x+((y-1)*grid_size)]>0 And CurrGrid\Grid[x+((y+1)*grid_size)]>0 Then
								If Rand(2) = 1 Then
									CurrGrid\RoomAngle[x+(y*grid_size)] = 2
								Else
									CurrGrid\RoomAngle[x+(y*grid_size)] = 0
								...
								CurrGrid\RoomType[x+(y*grid_size)] = ROOM2
							Else
								If CurrGrid\Grid[(x-1)+(y*grid_size)]>0 And CurrGrid\Grid[x+((y+1)*grid_size)]>0 And (x>=0) Then
									CurrGrid\RoomAngle[x+(y*grid_size)] = 2
								ElseIf CurrGrid\Grid[(x+1)+(y*grid_size)]>0 And CurrGrid\Grid[x+((y+1)*grid_size)]>0 And(x<grid_size-1) Then
									CurrGrid\RoomAngle[x+(y*grid_size)] = 1
								ElseIf CurrGrid\Grid[(x-1)+(y*grid_size)]>0 And CurrGrid\Grid[x+((y-1)*grid_size)]>0 And (x>=0) Then
									CurrGrid\RoomAngle[x+(y*grid_size)] = 3
								Else
									CurrGrid\RoomAngle[x+(y*grid_size)] = 0
								EndIf
								CurrGrid\RoomType[x+(y*grid_size)] = ROOM2C
							EndIf
						Case 3
							If (Not CurrGrid\Grid[x+((y-1)*grid_size)]) Then
								CurrGrid\RoomAngle[x+(y*grid_size)] = 2
							ElseIf (Not CurrGrid\Grid[(x-1)+(y*grid_size)]) And (x>=0) Then
								CurrGrid\RoomAngle[x+(y*grid_size)] = 1
							ElseIf (Not CurrGrid\Grid[(x+1)+(y*grid_size)]) And (x<=grid_size-1) Then
								CurrGrid\RoomAngle[x+(y*grid_size)] = 3
							Else
								CurrGrid\RoomAngle[x+(y*grid_size)] = 0
							EndIf
							CurrGrid\RoomType[x+(y*grid_size)] = ROOM3
						Case 4
							CurrGrid\RoomAngle[x+(y*grid_size)] = Rand(0,3)
							CurrGrid\RoomType[x+(y*grid_size)] = ROOM4
					End Select
				EndIf
			Next
		Next
		...
		For y = 1 To grid_size-2
			For x = 0 To grid_size-1
				If CurrGrid\Grid[x+(y*grid_size)]>0 Then
					DebugLog CurrGrid\RoomType[x+(y*grid_size)]
				EndIf
			Next
		Next
		...
		For rt.RoomTemplates = Each RoomTemplates
			If rt\Commonness = 0 And rt\AutoSpawn = False Then
				...
				Else
					For i = 0 To 1
						If rt\zone[i]=NTF_CurrZone Then
							correctzone = True
							Exit
						EndIf
					Next
					...
					Repeat
						If CurrGrid\Grid[x+(y*grid_size)]>0 And CurrGrid\RoomName[x+(y*grid_size)]="" Then
							If CurrGrid\RoomType[x+(y*grid_size)] = rt\Shape Then
								If Rand(1,5)=1 Then
									CurrGrid\RoomName[x+(y*grid_size)] = rt\Name
				...
				If CurrGrid\Grid[x+(y*grid_size)]>0 And CurrGrid\RoomName[x+(y*grid_size)]="" Then
					...
					For rt.RoomTemplates = Each RoomTemplates
						If rt\Commonness > 0 Then
							If rt\Shape = CurrGrid\RoomType[x+(y*grid_size)] Then
								correctzone = False
								If rt\zone[0]=0 Then
									correctzone = True
								Else
		...
		Local zone=NTF_CurrZone
		For y = 1 To grid_size-2
			For x = 0 To grid_size-1
				If CurrGrid\Grid[x+(y*grid_size)] > 0 Then
					r = CreateRoom(zone, CurrGrid\RoomType[x+(y*grid_size)],x*spacing,0,y*spacing,CurrGrid\RoomName[x+(y*grid_size)],CurrGrid\RoomAngle[x+(y*grid_size)]*90)
					If r = Null Then
						RuntimeError "Attempt to create room "+CurrGrid\RoomName[x+(y*grid_size)]+" was unsuccessful"
					EndIf
				EndIf
			Next
		Next
		...
		Select NTF_CurrZone
			Case EZ
				...
				r = CreateRoom(zone, ROOM1, endX*spacing, 0, (grid_size-1)*spacing, "checkpoint_ez")
				r\angle = 0
			Case LCZ
				r = CreateRoom(zone, ROOM1, startX*spacing, 0, 0, "cont_173")
				r\angle = 180
				TurnEntity(r\obj, 0, r\angle, 0)
				r = CreateRoom(zone, ROOM1, endX*spacing, 0, (grid_size-1)*spacing, "checkpoint_lcz")
				r\angle = 0
			Case HCZ
				r = CreateRoom(zone, ROOM1, startX*spacing, 0, 0, "room1_sewers")
				r\angle = 180
				TurnEntity(r\obj, 0, r\angle, 0)
				r = CreateRoom(zone, ROOM1, endX*spacing, 0, (grid_size-1)*spacing, "checkpoint_hcz")
				r\angle = 0
		End Select
	...
	For y = grid_size-1 To 0 Step -1
		zone = NTF_CurrZone
		For x = grid_size-1 To 0 Step -1
			If CurrGrid\Grid[x+(y*grid_size)] > 0 Then
				If zone = HCZ Then temp=2 Else temp=0
	...
	For i = 2 To CountSurfaces(entity)
		...
		If b<>0 Then
			...
			If t1<>0 Then
				...
				If Lower(name) <> "MonitorOverlay.jpg"
					If numb% = 0
						If MonitorTimer# < 50
...
Function UpdateChunks(r.Rooms,ChunkPartAmount%,spawnNPCs%=True)
	...
	For ch = Each Chunk
		...
		If (Not ch\IsSpawnChunk)
			If DistanceSquared(EntityX(Collider),EntityX(ch\ChunkPivot),EntityZ(Collider),EntityZ(ch\ChunkPivot))>PowTwo(ChunkMaxDistance)
				ch\ChunkPivot = FreeEntity_Strict(ch\ChunkPivot)
				Delete ch
			EndIf
		EndIf
	Next
	...
	Else
		For n = Each NPCs
			If n\NPCtype = NPCtype1499
				If EntityDistanceSquared(n\Collider,Collider)>PowTwo(ChunkMaxDistance) Lor EntityY(n\Collider)<EntityY(PlayerRoom\obj)-5
